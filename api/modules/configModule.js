...
var config = module.exports = {
  ...
  algos: {
    ...
    blake2s: {id: 16, name: "Blake256r8", dn: "blake256r8", port: 3349, profitability: null, unit: 3},
    blake256r14: {id: 17, name: "Blake256r14", port: 3350, profitability: null, unit: 3},
    blake256r8vnl: {id: 18, name: "Blake256r8vnl", port: 3351, profitability: null, unit: 3},
    ...
    fs.stat('settings.json', function (err, stat) {
      if (err == null) {
        ...
        config.config.benchmarks = {
          ...
          blake2s: {name: "Blake256r8", hashrate: null, enabled: true, benchRunning:null},
